using BaseballComponent.SQLite;
using System;
...
namespace BaseballComponent
{
    public sealed class Players
    {
        ...
        public PlayerBattingStats PattingStats { get; set; }
        public PlayerPitchingStats PitchingStats { get; set; }
    }
    ...
    public sealed class PlayerPitchingStats
    {
        public IList<PitchingStats> PitchingStats { get; set; }

        public PlayerPitchingStats(IList<PitchingStats> pitchingStats)
        {
    ...
    /// </summary>
    public sealed class PlayerBattingStats
    {
        public IList<BattingStats> BattingStats { get; set; }

        public PlayerBattingStats(IList<BattingStats> battingStats)
        {
    ...
    public sealed class BattingStats
    {
        [Column("playerID")]
        public string PlayerID { get; set; }
    ...
    public sealed class PitchingStats
    {
        [Column("playerID")]
        public string PlayerID { get; set; }
    ...
    public class Baseball
    {
        ...
        internal Baseball(SQLiteConnection connection)
        {
        ...
        private IList<Players> GetPlayersBornInState(string stateId)
        {
            return _connection.Query<Players>("select * from master where birthState=?", stateId);
        }

        public IAsyncOperation<IList<Players>> GetPlayersBornInStateAsync(string stateId)
        {
            return Task.Run(() => GetPlayersBornInState(stateId)).AsAsyncOperation();
        }

        private IList<Players> GetPlayersByName(string firstName, string lastName)
        {
            return _connection.Query<Players>("select * from master where nameFirst=? and nameLast=?", firstName, lastName);
        }

        public IAsyncOperation<IList<Players>> GetPlayersByNameAsync(string firstName, string lastName)
        {
